                    ...
                    show_source_list:function () {
                        ...
                        table.render({
                            ...
                            ,cols: [[
                                ...
                                {field: 'title', title: '素材标题',edit:'title',minWidth:'120',align: 'center'},
                                {field: 'image', title: '封面',templet:'<div><img src="{{ d.image }}"></div>',minWidth:'120',align: 'center'},
                                {field: 'pay_status', title: '是否免费',align: 'center',width:'120',templet:function(d){
                                ...
                                {field: 'right', title: '操作',align: 'center',width:'120',templet:function(d){
