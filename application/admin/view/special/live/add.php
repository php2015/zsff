            ...
            methods:{
                ...
                show_source_list:function () {
                    ...
                    table.render({
                        ...
                        ,id:'idTest'
                        ,cols: [[
                            {field: 'id', title: '编号', sort: true,event:'id',align: 'center',width:'10%'},
                            {field: 'title', title: '课程',edit:'title',align: 'center',width:'20%'},
                            {field: 'image', title: '封面',templet:'<div><img src="{{ d.image }}"></div>',width:'40%',align: 'center'},
